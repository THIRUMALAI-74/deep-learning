# ========================================================
# train_mobilenet.py
# Train bird sound classifier using MobileNetV2 + mel spectrograms
# ========================================================
...
TOP_K = 30
MODEL_NAME = "bird_sound_mobilenetv2.h5"
LABELS_CSV = "label_mapping_mobilenet.csv"
...
def train_model(dataset_dir):
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X, y_cat, test_size=0.2, stratify=y_cat, random_state=SEED
    )
...
if __name__ == "__main__":
    dataset_path = "Voice of Birds"   # <-- change this path
